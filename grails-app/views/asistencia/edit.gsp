...
<html>
    ...
    <body>
        ...
        <div id="edit-asistencia" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.asistencia}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.asistencia}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.asistencia}" method="PUT">
                <g:hiddenField name="version" value="${this.asistencia?.version}" />
                <fieldset class="form">
                    <f:all bean="asistencia"/>
                </fieldset>
