...
<html>
    ...
    <body>
        ...
        <div id="show-asistencia" class="content scaffold-show" role="main">
            ...
            <f:display bean="asistencia" />
            <g:form resource="${this.asistencia}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.asistencia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
